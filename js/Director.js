...
import { UpPipe } from "./runrime/UpPipe.js";
import { DownPipe } from "./runrime/DownPipe.js";
import { Pipe } from "./runrime/Pipe.js";
import { Land } from "./runrime/Land.js";
...
export class Director{
    ...
    // 创建水管的方法
    createPipes(){
        const minTop = this.dataStore.canvas.height/8; // 最小孩子
    ...
    run(){
        ...
        // 有没有出界的,出界就将其从数组中删除
            ...
            // 创建水管的条件:前面一组水管有没有越过屏幕中央,如果越过,则开始创建下一个水管
